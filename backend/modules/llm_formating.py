...
#                     "role": "system",
#                     "content": """
# You are a note formatting tool for a learning app. Your task is to transform messy information into well-structured markdown notes. Do not add any introductory sentences or comments or side notes. Only provide the formatted markdown content itself. Don't say anything related to "Here is the well-formatted markdown learning notes:"
...
#                 all_chunks_content += chunk_content

#         return all_chunks_content
#     except Exception as e:
#         print(f"Error formatting into new notes: {str(e)}")
#         return None
...
def format_note(note):
    try:
        client = OpenAI(
            api_key=os.getenv("GROQ_API_KEY"),  # Changed to use GROQ_API_KEY
